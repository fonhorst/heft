...
from heft.algs.gsa.cgsa.particle_operations import MappingParticle, Particle, ConfigurationParticle
from heft.algs.common.utilities import cannot_be_zero
from heft.algs.gsa.cgsa.mapping_operators import position_update
from heft.algs.gsa.cgsa.ordering_operators import generate as gsa_generate
...
def generate(wf, rm, estimator, schedule=None, fixed_schedule_part=None, current_time=0.0):
    particle = gsa_generate(wf, rm, estimator, schedule, fixed_schedule_part, current_time)
